...
export const About = () => {
  return (
    <section className="px-3 lg:px-20 my-20" id="about">
      ...
      <div className="flex items-center gap-16 flex-col md:flex-row">
        <div className="w-full md:w-1/2 relative">
          ...
          <div className="rounded-2xl bg-white p-4 shadow-lg max-w-[300px] absolute bottom-0 right-0 md:right-28 about_card before:bg-red overflow-hidden">
