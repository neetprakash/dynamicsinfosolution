    ...
    return (
        <footer>
            ...
            <div className=" p-2 md:p-6  lg:px-20 lg:py-10">
                <div className="grid grid-cols-5 text-white gap-8">
                    <div className="col-span-2 flex flex-col gap-8"><img src="/assets/nav/DIS_FNL_LOGO2.png" alt="dis_logo" className="max-w-40" />
